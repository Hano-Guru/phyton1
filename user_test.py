...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_user = User("Hano-Guru","instergram","Hano232")
    ...
    def test_init(self):
        ...
        '''
        self.assertEqual(self.new_user.username, "Hano-Guru")
        self.assertEqual(self.new_user.account_name, "instergram")
        self.assertEqual(self.new_user.password, "Hano232")
    ...
    def test_find_user_by_username(self):
        ...
        found_user = User.find_by_username("Hano-Guru")
    ...
    def test_user_exists(self):
        ...
        user_exists = User.user_exist("Hano-Guru")
